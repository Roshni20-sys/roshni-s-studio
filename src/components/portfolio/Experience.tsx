  ...
  return (
    <section id="experience" className="py-32 md:py-40 bg-card relative grain-overlay">
      <div className="section-container">
        ...
        {/* Experience 1 */}
        <div ref={ref} className="grid lg:grid-cols-12 gap-12 lg:gap-20 mb-20">
          {/* Timeline left side */}
          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <motion.div
                ...
                className="mt-10 flex flex-wrap gap-3"
              >
                {["Python", "Problem Solving", "Clean Code", "Modular Design"].map((tag) => (
                  <span
                    key={tag}
                    className="px-4 py-2 bg-muted text-muted-foreground text-sm rounded-full"
                  >
