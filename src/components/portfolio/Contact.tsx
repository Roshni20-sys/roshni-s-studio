      ...
      <div className="section-container">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <motion.p
            ...
            className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto mb-16"
          >
          ...
          >
            <a
              ...
              className="block text-2xl md:text-3xl text-foreground hover:text-primary transition-colors duration-300 underline-animation"
            >
              hembromramo145@gmail.com
            </a>
            <a
              href="tel:+919932108347"
              className="block text-xl md:text-2xl text-muted-foreground hover:text-foreground transition-colors duration-300"
            >
              +91 9932108347
            </a>
          </motion.div>
