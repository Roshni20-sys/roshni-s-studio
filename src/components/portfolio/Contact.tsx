...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-32 md:py-40 relative overflow-hidden grain-overlay">
      {/* Animated mesh gradient background */}
      <div className="absolute inset-0 -z-10">
        <motion.div
          animate={{ scale: [1, 1.2, 1], x: [0, 50, 0], y: [0, -30, 0] }}
          transition={{ duration: 20, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-1/4 -left-32 w-96 h-96 rounded-full bg-primary/[0.04] blur-[100px]"
        />
        <motion.div
          animate={{ scale: [1.2, 1, 1.2], x: [0, -40, 0], y: [0, 40, 0] }}
          transition={{ duration: 25, repeat: Infinity, ease: "easeInOut" }}
          className="absolute bottom-1/4 -right-32 w-96 h-96 rounded-full bg-secondary/[0.04] blur-[100px]"
        />
      </div>
          ...
          >
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-secondary/30 bg-secondary/5">
                ...
                />
                <span className="text-xs uppercase tracking-[0.2em] text-secondary font-medium">Currently available for work</span>
              </div>
            </motion.div>
                      ...
                      <Tooltip key={social.label}>
                        <TooltipTrigger asChild>
                          <motion.a
                            ...
                            whileTap={{ scale: 0.95 }}
                            className="w-12 h-12 rounded-full border border-border/30 flex items-center justify-center text-muted-foreground hover:text-foreground hover:border-primary/50 hover:bg-primary/5 transition-colors duration-300"
                          >
                            {social.icon}
                          </motion.a>
                        </TooltipTrigger>
